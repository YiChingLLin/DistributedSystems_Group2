...
public class calculator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "off"); // "off", "trace", "debug",
                                                                                      // "info", "warn", "error".
        InitConsumer();
        InitProducer();
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, Bus> record : records) {
                ...
                try {
                    ...
                    System.out.println("Bus " + busRecord.getCarNumber() + " now have "
                            + currentNumber.get(busRecord.getCarNumber()) + " people.");
    ...
    private static void InitConsumer() {
        ...
        propsConsumerLocalBalance.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
        ...
        consumerFromCurrent = new KafkaConsumer<String, BusCurrent>(propsConsumerLocalBalance);
    }
    ...
    private static void InitProducer() {
        ...
        propsTxWrite.put("transactional.id", UUID.randomUUID().toString()); // Should be different between validators to
                                                                            // avoid being fenced due to same
                                                                            // transactional.id.
    ...
    private static void Process(Bus tx) throws ExecutionException, InterruptedException {
        ...
        producer.send(new ProducerRecord<String, BusCurrent>("crowdedness", Match(carNumberList, tx.getCarNumber()),
                tx.getCarNumber(), Record(tx)));
    }
}
